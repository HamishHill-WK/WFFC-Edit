...
BEGIN_MESSAGE_MAP(MFCMain, CWinApp)
	...
	ON_COMMAND(ID_BUTTON40006, &MFCMain::TerrainEditor)	//hh
	ON_COMMAND(ID_BUTTON40007, &MFCMain::switchObjMode)//hh
	ON_COMMAND(ID_BUTTON40008, &MFCMain::switchCamNum)//hh
	ON_COMMAND(ID_BUTTON40009, &MFCMain::switchCamModeCine)//hh
	ON_COMMAND(ID_BUTTON40011, &MFCMain::switchCamModeMain)//hh
	ON_COMMAND(ID_BUTTON40012, &MFCMain::switchCamModeStill)//hh
